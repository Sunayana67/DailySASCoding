...
Use this for subject field:                                    
    Comments for (insert author(s) name(s) here)

                                                               

While the exact details of how to handle zip files depends on whether you are on a PC or Mac, the browser you are using, and the tool you are using
to unzip or decompress the file, here are some general guidelines to follow: 
...
9.   You will be prompted to choose a location on your computer to put the files. Choose the folder you created for this purpose
and confirm your selection.


*If you are using these examples with the SAS University Edition, you will need to create a shared folder to store the SAS files used in the book. Visit http://support.sas.com/software/products/university-edition/faq/shared_folder_access_existing.htm
for details.
